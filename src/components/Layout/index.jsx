  ...
  return (
    <div className={styles.root}>
      <h1 className={styles.title}>
        Домашняя работа по теме "Функциональное программирование" в рамках
        программы ШРИ.
      </h1>

      <p>
        Для решения используйте Ramda или любые другие библиотеки. Ramda,
        Lodash уже добавлены в package.json Оставьте файловую структуру и
        интерфейс функций без изменений. Это поможет нам быстрее проверить
        работу. Максимально используйте функциональное программирование!
      </p>
